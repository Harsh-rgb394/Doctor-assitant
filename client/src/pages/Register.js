  ...
  return (
    <>
        <div  className='form-container'>
          <Form layout='vertical' onFinish={onfinishHandler} className='register_form'>
            ...
            <Link  to="/login" className='direct'>Already register </Link>

            <button className="btn btn-primary" type='submit'> Register it</button>
